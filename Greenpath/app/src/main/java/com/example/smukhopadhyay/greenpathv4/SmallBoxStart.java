 ...
 */
public class SmallBoxStart extends AsyncTask{
    @Override
    protected Object doInBackground(Object[] params) {
        ...
        Log.i("OVERPASS URL START", OverpassURL);
        ...
        try {
            ...
            LatLng closestPoint = Utilities.findClosest(OSMobject.toString(), MapsActivity.getStartingPoint(), "start");

            MapsActivity.setClosestPointToStart(closestPoint);
    ...
    protected void onPostExecute(Object o) {
        ...
        MapsActivity.setTextView("Starting point : " + o.toString());
        //MapsActivity.mMap.addMarker(new MarkerOptions().position(MapsActivity.getClosesPointToStart()).title("Closest Point to Start"));
        PolylineOptions polylineOptions = new PolylineOptions()
                .add(MapsActivity.getStartingPoint())
                .add(MapsActivity.getClosesPointToStart());
